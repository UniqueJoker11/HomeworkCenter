...
public class TemperController extends BaseController{
    ...
    public Map<String,Object> fetchCurrentTemper(@RequestParam(value = "start",required = true)String start,@RequestParam(value = "end",required = true)String end){
        Map<String,Object> searchParam=new HashMap<>();
        searchParam.put("start_date",start);
        searchParam.put("end_date",end);
