...
public class HomeworkConstants {
    ...
    //文章分类页面
    public static final String PAGE_ATICLE_CATEGORY_VIEW="aticle_category";
    ...
    //文章分类页面
    public static final String CONTROLLER_ATICLE_CATEGORY_SHOW_PAGE="/aticle_category.html";
