 ...
 */
public class HomeworkUserinfoDetail {
    ...
    private String user_info_gendar;
    private String user_info_blood;
    private String user_info_qq;
    private String user_info_college;
    ...
    public String getUser_info_gendar() {
        return user_info_gendar;
    }

    public void setUser_info_gendar(String user_info_gendar) {
        this.user_info_gendar = user_info_gendar;
    }

    public String getUser_info_blood() {
        return user_info_blood;
    }

    public void setUser_info_blood(String user_info_blood) {
        this.user_info_blood = user_info_blood;
    }
    ...
    public void setUser_info_qq(String user_info_qq) {
        this.user_info_qq = user_info_qq;
    }

    public String getUser_info_college() {
        return user_info_college;
    }
